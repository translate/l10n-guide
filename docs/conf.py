# -*- coding: utf-8 -*-
#
# Localization Guide build configuration file.
#
...
htmlhelp_basename = 'LocalizationGuidedoc'
...
latex_documents = [
  ('index', 'LocalizationGuide.tex', u"Translate's Localization Guide",
   u'Translate', 'manual'),
]
...
man_pages = [
    ('index', 'localization-guide', u"Translate's Localization Guide",
     [u'Translate'], 1)
]
